(ns marketentry.store
  "SSoT for the Latvia market-entry compliance actor, behind a `Store`
  ...
  `:requires-ur-registration?`/`:has-ur-registration?` ground the
  Uzņēmumu reģistrs (Register of Enterprises) business-registration
  check; `:requires-vat-registration?`/`:vat-registration-verified?`
  ground the VID VAT-registration check -- see `marketentry.governor`.
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems SIA" :portal "EIS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ur-registration? true :has-ur-registration? true
             :requires-vat-registration? true :vat-registration-verified? true
             :drafted? false :submitted? false
             :jurisdiction "LVA" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "EIS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ur-registration? true :has-ur-registration? true
             :requires-vat-registration? true :vat-registration-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "EIS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "LVA" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "EIS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ur-registration? true :has-ur-registration? false
             :requires-vat-registration? true :vat-registration-verified? true
             :drafted? false :submitted? false
             :jurisdiction "LVA" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "EIS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ur-registration? true :has-ur-registration? true
             :requires-vat-registration? true :vat-registration-verified? false
             :drafted? false :submitted? false
             :jurisdiction "LVA" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "EIS"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-ur-registration? has-ur-registration?
                               requires-vat-registration? vat-registration-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-ur-registration?)     (assoc :engagement/requires-ur-registration? requires-ur-registration?)
    (some? has-ur-registration?)          (assoc :engagement/has-ur-registration? has-ur-registration?)
    (some? requires-vat-registration?)    (assoc :engagement/requires-vat-registration? requires-vat-registration?)
    (some? vat-registration-verified?)    (assoc :engagement/vat-registration-verified? vat-registration-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-ur-registration? :engagement/has-ur-registration?
   :engagement/requires-vat-registration? :engagement/vat-registration-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-ur-registration? (boolean (:engagement/requires-ur-registration? m))
     :has-ur-registration? (boolean (:engagement/has-ur-registration? m))
     :requires-vat-registration? (boolean (:engagement/requires-vat-registration? m))
     :vat-registration-verified? (boolean (:engagement/vat-registration-verified? m))
